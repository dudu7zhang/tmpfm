#!/usr/bin/env python3
"""
Squidiff on Norman 2019 dataset with holdout split.
...
_BASE_OUTPUT_DIR = Path(__file__).resolve().parent.parent.parent / "results" / "outputs" / "outputs_squidiff_norman_holdout"
...
print(f"[Squidiff-Norman-Holdout] Start at {timestamp}")
...
# ===================== Evaluation =====================
print("\n" + "=" * 50)
evaluate_predictions(ctrl_adata, adata_test, adata_pred, str(OUTPUT_DIR / f"squidiff_norman_holdout_{timestamp}"))
print("=" * 50)
print("Done.")
