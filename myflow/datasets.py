...
from myflow._types import PathLike
...
def ineurons(
    path: PathLike = "~/.cache/myflow/ineurons.h5ad",
...
def pbmc_cytokines(
    path: PathLike = "~/.cache/myflow/pbmc_parse.h5ad",
    force_download: bool = False,
    **kwargs: Any,
) -> ad.AnnData:
...
def zesta(
    path: PathLike = "~/.cache/myflow/zesta.h5ad",
    force_download: bool = False,
    **kwargs: Any,
) -> ad.AnnData:
