#!/bin/bash
# =============================================================================
# Run ALL 6 CellFlow experiments (3 Baseline + 3 Our Method)
...
echo "=========================================="
echo "Starting ALL 6 CellFlow experiments"
echo "Conda env: flow"
echo "Run ID: $RUN_ID"
...
# =============================================================================
# Part 1: CellFlow Baseline (No Graph Fusion) - 3 experiments
# =============================================================================
echo ""
echo "=== [1/2] Starting CellFlow Baseline (3 experiments) ==="
...
# =============================================================================
# Part 2: CellFlow Our Method (With Graph Fusion) - 3 experiments
# =============================================================================
echo ""
echo "=== [2/2] Starting CellFlow Our Method (3 experiments) ==="

echo "Starting: method_norman_additive (GPU $GPU_METHOD_ADDITIVE)"
CUDA_VISIBLE_DEVICES=$GPU_METHOD_ADDITIVE nohup python "$CELLFLOW_DIR/train_cellflow_norman_scdfm_additive.py" \
...
CUDA_VISIBLE_DEVICES=$GPU_METHOD_HOLDOUT nohup python "$CELLFLOW_DIR/train_cellflow_norman_scdfm_holdout.py" \
...
CUDA_VISIBLE_DEVICES=$GPU_METHOD_LOCO nohup python "$CELLFLOW_DIR/train_cellflow_loco_new.py" \
