...
with open('/home/zhangshibo24s/cell_flow/train_cellflow_Replogle_Nadig.py', 'r') as f:
    content = f.read()
...
with open('/home/zhangshibo24s/cell_flow/train_cellflow_loco.py', 'w') as f:
    f.write(content)
print('Successfully generated train_cellflow_loco.py')
