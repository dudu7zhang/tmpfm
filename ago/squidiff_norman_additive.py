...
_BASE_OUTPUT_DIR = Path(__file__).resolve().parent.parent.parent / "results" / "outputs" / "outputs_squidiff_norman_additive"
...
print(f"[Squidiff-Norman-Additive] Start at {timestamp}")
...
# ===================== Evaluation =====================
print("\n" + "=" * 50)
evaluate_predictions(ctrl_adata, adata_test, adata_pred, str(OUTPUT_DIR / f"squidiff_norman_additive_{timestamp}"))
print("=" * 50)
print("Done.")
