...
EXPERIMENTS=(
    ...
    "myflow_loco"
    "myflow_baseline_norman_additive"
    "myflow_baseline_norman_holdout"
    "myflow_baseline_loco"
...
echo "  Kill all: pkill -f 'python.*train_myflow\|python.*gears\|python.*scdfm\|python.*perturbdiff\|python.*squidiff'"
echo "=========================================="
