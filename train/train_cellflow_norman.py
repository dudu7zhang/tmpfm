...
def main():
    ...
    shuffled_conditions = rng.permutation(pert_conditions)
    n_test_conditions = max(1, int(round(args.test_condition_fraction * len(shuffled_conditions))))
    test_conditions = set(shuffled_conditions[:n_test_conditions])
    train_conditions = set(pert_conditions) - test_conditions
    ...
    print("Norman 2019 perturbation condition split:")
    print(f"  Perturbation conditions in Train: {len(train_conditions)}")
    print(f"  Perturbation conditions in Test : {len(test_conditions)} ({args.test_condition_fraction:.2%})")
