#!/usr/bin/env python3
"""PBMC CellFlow training script migrated from train_100_pbmc.ipynb."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train CellFlow on PBMC cytokine data.")
    parser.add_argument(
        "--data-path",
        type=str,
        default="/home/zhangshibo24s/cell_flow/data_train/pbmc_adata_for_cellflow_datasets_with_embeddings.h5ad",
